...
uses Classes, SysUtils, Forms, ActnList, ComCtrls, StdCtrls, Controls, ExtCtrls
  , System.Actions
  , MARS.http.Server.Indy, Data.DB, Datasnap.DBClient
;
...
type
  TMainForm = class(TForm)
    ...
    mlogserver: TMemo;
    CDascext: TClientDataSet;
    CDascextcaracter: TStringField;
    CDascextascord: TIntegerField;
...
uses
  ...
  , Server.Ignition
  , UDataCclConfig,  UTools_CLX, UAcessos, UModulos
;
